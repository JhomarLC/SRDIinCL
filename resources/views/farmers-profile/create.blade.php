            ...
            <div class="card-body">
                <form action="#" class="form-steps" autocomplete="off">
                    ...
                    <div class="tab-content">
                        @include('farmers-profile.components.create-tabs.1-tabpanel')
                        @include('farmers-profile.components.create-tabs.2-tabpanel')
                        @include('farmers-profile.components.create-tabs.3-tabpanel')
                        @include('farmers-profile.components.create-tabs.4-tabpanel')
                        @include('farmers-profile.components.create-tabs.5-tabpanel')
                        @include('farmers-profile.components.create-tabs.6-tabpanel')
                    </div>
                    <!-- end tab content -->
                </form>
            </div>
