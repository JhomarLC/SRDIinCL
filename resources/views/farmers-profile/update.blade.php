            ...
            <div class="card-body">
                <form action="#" id="updateFarmersProfileForm" class="form-steps" autocomplete="off">
                    ...
                    <div class="tab-content">
                        @include('farmers-profile.components.update-tabs.1-tabpanel')
                        @include('farmers-profile.components.update-tabs.2-tabpanel')
                        @include('farmers-profile.components.update-tabs.3-tabpanel')
                        @include('farmers-profile.components.update-tabs.4-tabpanel')
                        @include('farmers-profile.components.update-tabs.5-tabpanel')
                        @include('farmers-profile.components.update-tabs.6-tabpanel')
                    </div>
                    <!-- end tab content -->
                </form>
            </div>
...
@include('farmers-profile._includes.update-script')
@endsection
