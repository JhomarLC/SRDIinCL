...
@include('admin.training-evaluation-management.components.modal-create')
@include('admin.training-evaluation-management.components.modal-update')
@include('admin.training-evaluation-management.components.status-update')
...
@include('admin.training-evaluation-management._includes.script')
