...
<!--end modal -->
 ...
 <!-- Modal -->
 <div class="modal fade zoomIn" id="approveAccountModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="deleteRecord-close"></button>
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    ...
                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4>Are you Sure ?</h4>
                        <p class="text-muted mx-4 mb-0">Are you sure you want to approve AEW account?</p>
                    </div>
                </div>
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                    <form id="approveAEWForm" method="POST" style="display:inline;">
                        @csrf
                        @method('PUT')
                        <input type="text" hidden id="approve-edit-id">
                        <button type="submit" class="btn w-sm btn-danger">Yes, Approve It!</button>
                    </form>
...
<!--end modal -->
 ...
 <!-- Modal -->
 <div class="modal fade zoomIn" id="declineAccountModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="deleteRecord-close"></button>
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    ...
                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4>Are you Sure ?</h4>
                        <p class="text-muted mx-4 mb-0">Are you sure you want to decline AEW account?</p>
                    </div>
                </div>
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                    <form id="declineAEWForm" method="POST" style="display:inline;">
                        @csrf
                        @method('PUT')
                        <input type="text" hidden id="decline-edit-id">
                        <button type="submit" class="btn w-sm btn-danger">Yes, Decline It!</button>
                    </form>
