...
@include('admin.speaker-management.components.modal-create')
@include('admin.speaker-management.components.modal-update')
@include('admin.speaker-management.components.status-update')
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <table id="speakers" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    <thead>
                        <tr>
...
@include('admin.speaker-management._includes.script')
