<script>
    ...
    $(document).ready(function () {
        ...
        $("#updateAdminForm").submit(function (e) {
            ...
            $.ajax({
                url: "/admin-management/" + userId, // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
    ...
    $(document).ready(function () {
        ...
        $("#activateAdminForm").submit(function (e) {
            ...
            $.ajax({
                url: "/admin-management/" + userId + "/activate", // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
        ...
        $("#deactivateAdminForm").submit(function (e) {
            ...
            $.ajax({
                url: "/admin-management/" + userId + "/deactivate", // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
