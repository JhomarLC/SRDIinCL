<div class="modal fade" id="addnewadminmodal" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalgridLabel">Add Admin Account</h5>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div class="hstack gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-secondary"> <i class="ri-user-add-line"></i> Add new admin</button>
                            </div>
                        </div>
                    </div>
                </form>
