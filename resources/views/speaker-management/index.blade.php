...
@include('speaker-management.components.modal-create')
@include('speaker-management.components.modal-update')
@include('speaker-management.components.status-update')
...
@include('speaker-management._includes.script')
