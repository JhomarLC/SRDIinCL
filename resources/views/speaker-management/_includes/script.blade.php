<script>
    ...
    $(document).ready(function () {
        ...
        $("#updateSpeakerForm").submit(function (e) {
            ...
            $.ajax({
                url: "/speaker-management/" + userId, // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
    ...
    $(document).ready(function () {
        ...
        $("#activateSpeakerForm").submit(function (e) {
            ...
            $.ajax({
                url: "/speaker-management/" + userId + "/unarchive", // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
        ...
        $("#archiveSpeakerForm").submit(function (e) {
            ...
            $.ajax({
                url: "/speaker-management/" + userId + "/archive", // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
