...
@include('speaker-management.speaker-topics.components.modal-create')
@include('speaker-management.speaker-topics.components.modal-update')
@include('speaker-management.speaker-topics.components.status-update')
...
@include('speaker-management.speaker-topics._includes.script')
