            ...
            <div class="card-body">
                <form action="#" class="form-steps" autocomplete="off">
                    ...
                    <div class="tab-content">
                        @include('speaker-management.speaker-topics.speaker-evaluations.components.create-tabs.1-tabpanel')
                        @include('speaker-management.speaker-topics.speaker-evaluations.components.create-tabs.2-tabpanel')
                    </div>
                    <!-- end tab content -->
                </form>
            </div>
