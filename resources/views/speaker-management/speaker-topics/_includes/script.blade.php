<script>
    ...
    $(document).ready(function () {
        ...
        $("#updateTopicForm").submit(function (e) {
            ...
            $.ajax({
                url: "/speaker-management/" + speakerId + "/topics/" + topicId,
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
    ...
    $(document).ready(function () {
        ...
        $("#activateTopicForm").submit(function (e) {
            ...
            let speakerId = $("#speaker_id").val();
            $.ajax({
                url: "/speaker-management/" + speakerId + "/topics/" + topicId + "/unarchive",
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
        ...
        $("#archiveTopicForm").submit(function (e) {
            ...
            let speakerId = $("#speaker_id").val();
            $.ajax({
                url: "/speaker-management/" + speakerId + "/topics/" + topicId + "/archive",
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
