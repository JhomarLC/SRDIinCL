    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Farmers by Sex</h4>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                <div id="farmers_by_sex"
                    ...
                    <div id="gender-subtitle">Analyzing data...</div>
            </div><!-- end card-body -->
        </div><!-- end card -->
    </div>
    <!-- end col -->
