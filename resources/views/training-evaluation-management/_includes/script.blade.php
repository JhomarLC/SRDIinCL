<script>
    ...
    $(document).ready(function () {
        ...
        $("#updateTrainingEventForm").submit(function (e) {
            ...
            $.ajax({
                url: "/training-evaluation-management/" + training_eventId,
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
    ...
    $(document).ready(function () {
        ...
        $("#activateTrainingEventForm").submit(function (e) {
            ...
            $.ajax({
                url: "/training-evaluation-management/" + eventId + "/unarchive", // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
        ...
        $("#archiveTrainingEventForm").submit(function (e) {
            ...
            $.ajax({
                url: "/training-evaluation-management/" + eventId + "/archive", // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
