<script>
    ...
    $(document).ready(function () {
        ...
        $("#updateAEWForm").submit(function (e) {
            ...
            $.ajax({
                url: "/aews-management/" + userId, // Laravel route for updating aew
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
    ...
    $(document).ready(function () {
        ...
        $("#approveAEWForm").submit(function (e) {
            ...
            $.ajax({
                url: "/aews-management/" + userId + "/approve", // Laravel route for updating aews
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
        ...
        $("#declineAEWForm").submit(function (e) {
            ...
            $.ajax({
                url: "/aews-management/" + userId + "/decline", // Laravel route for updating aews
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
        ...
        $("#activateAEWForm").submit(function (e) {
            ...
            $.ajax({
                url: "/aews-management/" + userId + "/activate", // Laravel route for updating aews
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
        ...
        $("#deactivateAEWForm").submit(function (e) {
            ...
            $.ajax({
                url: "/aews-management/" + userId + "/deactivate", // Laravel route for updating admin
                type: "PUT",
                data: formData,
                dataType: "json",
                success: function (response) {
